...
module.exports = {
    ...
    async run(message, args, client) {
        ...
        const msg = await message.channel.send(InfoEmbed("", "<a:loading:752246174550982728> Processing filter `SubBoost`."));
        ...
        msg.edit(InfoEmbed("", `<:yes:752247197436870666> Subboost has been ${currentFilters[this.config.command]? "enabled" : "disabled"}`))
    ...
    config: {
        command: "subboost",
        aliases: [],
        description: "Add subboost effect.",
        permissions: [],
        usage: `subboost`
    }
}