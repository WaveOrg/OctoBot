...
module.exports = {
    ...
    async run(message, args, client) {
        ...
        const msg = await message.channel.send(InfoEmbed("", "<a:loading:752246174550982728> Processing filter `MCompand`."));
    ...
    msg.edit(InfoEmbed("", `<:yes:752247197436870666> MCompand has been ${currentFilters[this.config.command]? "enabled" : "disabled"}`))
